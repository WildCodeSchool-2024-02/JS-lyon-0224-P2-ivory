  ...
  return (
    <div className="lesson">
      ...
      <div className="contentLesson">
        ...
        <h4>HTML Elements</h4>
        <p>
          An HTML element is defined by its start tag , its content and its end
          tag. <br />
        ...
        <p>Examples of tagnames :</p>
        <img src="./src/assets/Tag_examples.jpg" alt="tag_example" />
        <h4>Web Browser</h4>
        <p>
          Web browsers are used to read HTML documents and display them properly
      ...
      <div className="menuRessourcesVideo">
        ...
        <div className="ressourceVideo">
          <iframe
            src="https://www.youtube.com/embed/it1rTvBcfRg?si=ojcThi5WT5ToKVpg"
